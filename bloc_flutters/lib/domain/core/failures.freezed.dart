...
mixin _$ValueFailure<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(T? failedValue) invalidLogin,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(T? failedValue)? invalidLogin,
  ...
  TResult map<TResult extends Object?>({
    ...
    required TResult Function(InvalidLogin<T> value) invalidLogin,
  ...
  TResult? mapOrNull<TResult extends Object?>({
    ...
    TResult Function(InvalidLogin<T> value)? invalidLogin,
...
class _$InvalidLogin<T> implements InvalidLogin<T> {
  const _$InvalidLogin({required this.failedValue});
  ...
  @override
  String toString() {
    return 'ValueFailure<$T>.invalidLogin(failedValue: $failedValue)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return invalidLogin?.call(failedValue);
  }
...
abstract class InvalidLogin<T> implements ValueFailure<T> {
  const factory InvalidLogin({required T? failedValue}) = _$InvalidLogin<T>;
